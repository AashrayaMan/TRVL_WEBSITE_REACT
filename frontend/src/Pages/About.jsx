...
import jpai from '../Components/Assests/bannnn.jpg'
import about from '../Components/Assests/ABOUT.jpeg'
import './About.css'
import '../Components/Stays/StaysCard.css'

const About = () => {
  return (
    <div className="About">
     <div className='popularr'>
       <img className='h' src={jpai} alt="" />
       <h1 >Tours</h1>
      
       <hr />
       <p><h2>TRVL</h2><br />

“Travel is the main thing you purchase that makes you more extravagant”. We, at TRVL, swear by this and put stock in satisfying travel dreams that make you perpetually rich constantly.
<br />
